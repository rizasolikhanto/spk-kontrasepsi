            ...
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                        <li class="nav-item {{ Request::is('user/dashboard') ? 'active' : '' }}">
                            <a class="nav-item-hold active" href="/user/dashboard"><i class="fas fa-tachometer-alt"></i><span class="nav-text">Dashboard</span></a>
                            <div class="triangle"></div>
                        </li>
                        <li class="nav-item {{ Request::is('user/consultations/') ? 'active' : '' }}">
                            <a class="nav-item-hold" href="/user/consultations/"><i class="fas fa-stethoscope"></i><span class="nav-text">Konsultasi</span></a>
                            <div class="triangle"></div>
                        </li>
                        <li class="nav-item {{ Request::is('user/consultations/history') ? 'active' : '' }}">
                            <a class="nav-item-hold" href="/user/consultations/history"><i class="fas fa-hand-sparkles"></i><span class="nav-text">Riwayat Konsultasi</span></a>
                            <div class="triangle"></div>
                        </li>
                </ul>
            </div>
